...
const UpdateTouristSpot = () => {
    ...
    const handleUpdatedLocation = event => {
      ...
      const updateLocation = { tourists_spot_name, country_Name, average_cost, totalVisitorsPerYear, location, seasonality,image, travel_time, short_description}
        ...
        <title> Travel Trek | Update Tourist Spot</title>
          ...
          <div className="shadow-lg p-5 border dark:bg-[#1a2641d5]">
            ...
            <form onSubmit={handleUpdatedLocation}>
              ...
              <textarea id="description" name="short_description"  defaultValue={short_description}  rows="7" placeholder="short description" className="w-full rounded-md  focus:outline-[#FF8900] text-black  border p-3 "></textarea>
              <input
